...
let ex10 = Branch(Guide("x",(Guide("y",Guide("z",Guide ("w",Branch(Branch(End(NameBox"x"),End(NameBox"y")),Branch(End(NameBox"z"),End(NameBox"w")))))))),Branch(End(NameBox "a"),End(NameBox "a")))
let ex11 = Guide("x",Guide("z",Guide("y", Branch(Branch(Branch(End(NameBox"x"),End(NameBox"y")),Branch(End(NameBox"z"),End(NameBox"y"))),Branch(Branch(End(NameBox"x"),End(NameBox"y")),Branch(End(NameBox"z"),End(NameBox"y")))))))
