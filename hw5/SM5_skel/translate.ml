...
module Translator = struct
  ...
  let rec trans : K.program -> Sm5.command = function
    ...
    | K.VAR i -> failwith "Unimplemented"
    ...
    | K.ASSIGN (id, exp) -> failwith "Unimplemented"
    | K.SEQ (e1, e2)-> failwith "Unimplemented"
    | K.IF (e1, e2, e3) -> failwith "Unimplemented"
    ...
    | K.WRITE e -> failwith "Unimplemented"
